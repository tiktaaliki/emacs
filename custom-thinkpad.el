...
(custom-set-faces
 ...
 '(link ((t (:inherit button :foreground "#51afef" :underline t :weight normal :family "DejaVu Sans Mono"))))
 ...
 '(org-date ((t (:inherit modus-themes-fixed-pitch :foreground "#ECBE7B" :underline t :height 0.95 :family "monofur"))))
 ...
 '(org-link ((t (:height 0.95 :foreground "indian red" :inherit link))))
 '(org-list-dt ((t nil)))
