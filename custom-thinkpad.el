...
(custom-set-faces
 ...
 '(org-timeblock-blue ((t (:extend t :background "#242679" :foreground "#8fcfff" :height 0.5))))
 '(org-timeblock-cyan ((t (:extend t :background "#004065" :foreground "#8eecf4" :height 0.7))))
 '(org-timeblock-green ((t (:extend t :background "#00422a" :foreground "#aceaac" :height 0.7 :width normal))))
 '(org-timeblock-magenta ((t (:extend t :background "#71206a" :foreground "#ffccff" :height 0.8))))
 '(org-timeblock-select ((t (:extend t :background "#3f1651" :height 0.8))))
 '(org-timeblock-yellow ((t (:extend t :background "#693200" :foreground "#fff29a" :height 0.5))))
