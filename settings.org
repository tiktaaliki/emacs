...
'(org-habit-clear-face ((t
  (:foreground "white" :background "DodgerBlue1"))))
    ...
    '(org-level-1 ((t (:inherit nil :foreground "gray"  :height 1.2 :family "futura"))))
    '(org-level-2 ((t (:inherit variable-pitch :foreground "light goldenrod" :height 1.1))))
    ...
    '(org-list-dt ((t (:foreground "midnight blue" :weight bold :background "lightgoldenrod1" :underline nil ))))
...
#+BEGIN_SRC emacs-lisp :tangle yes
   ...
   (setq mu4e-headers-fields
         '( (:human-date    .  8)    ;; alternatively, use :human-date
            (:flags         .   6)
            (:from          .  16)
;            (:thread-subject       . 90 )
            (:thread-subject       . 70 )
