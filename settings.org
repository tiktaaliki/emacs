...
#+BEGIN_SRC emacs-lisp :tangle yes
 ...
 '(org-habit-ready-face ((t (:background "#63de5d" :foreground "black"))))
  ...
  '(org-habit-overdue-future-face ((t (:background "#8b668b" :foreground "white"))))
    ...
    '(org-list-dt ((t (:foreground "black" :weight bold :background "yellow" :underline nil ))))
...
(setq org-ref-bibliography-entry-format '(("article" . "%a. (%y). %t. <i>%j</i>, <b>%v(%n)</b>, %p . <a href=\"%U\">link</a>. <a href=\"http://dx.doi.org/%D\">doi</a>.")
  ("book" . "%a, %t, %u (%y).")
...
#+RESULTS:
: ((article . %a. (%y). %t. <i>%j</i>, <b>%v(%n)</b>, %p . <a href="%U">link</a>. <a href="http://dx.doi.org/%D">doi</a>.) (book . %a, %t, %u (%y).) (techreport . %a, %t, %i, %u (%y).) (proceedings . %e, %t in %S, %u (%y).) (inproceedings . %a, %t, %p, in %b, edited by %e, %u (%y)))
** org noter
#+BEGIN_SRC emacs-lisp :tangle yes
...
** org-habit
#+BEGIN_SRC emacs-lisp :tangle yes
   (setq org-habit-following-days 8)
