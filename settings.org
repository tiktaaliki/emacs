...
("a" "daily clock/task log" entry (file+olp+datetree "~/Sync/Zettelkasten/journal.org") "** %<%H:%M> %? \n\n\n\n"  :clock-in t :clock-keep t :kill-buffer nil ) 
...
("m" "james" checkitem (file+headline "~/Sync/Zettelkasten/projects.org" "James") " [ ] %?" :prepend t :clock-in t )
...
(setq org-capture-templates
      '(("t" "Todo" entry (file "~/Sync/Zettelkasten/inbox.org")
         "* TODO %?\n  %i\n  %a" :clock-in t)
        ("j" "Journal" entry (file+datetree "~/Sync/Zettelkasten/journal.org")
         "* %?\nEntered on %U\n  %i\n  %a" :clock-in t)))
