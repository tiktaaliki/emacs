...
*** custom-set-faces
    ...
    '(default ((t (:inherit nil :stipple nil :background "#242728" :foreground "bisque1" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 230 :width normal :family "ubuntu mono"))))                    
...
#+BEGIN_SRC emacs-lisp :tangle yes
(setq mu4e-attachment-dir "~/Sync/Zettelkasten/QCSpring2018/misc")
...
;(setq org-archive-location "~/Sync/Zettelkasten/journal.org::datetree/* Finished tasks")
 ...
 #+RESULTS:
 : ~/Sync/Zettelkasten/journal.org::datetree/
