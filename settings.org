...
#+BEGIN_SRC emacs-lisp :tangle yes
   ...
   (custom-set-faces 
    '(default ((t (:inherit nil :stipple nil :background "#242728" :foreground "bisque1" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 200 :width normal :family "Consolas"))))                    
...
'(org-habit-clear-face ((t
  (:foreground "white" :background "DodgerBlue1"))))
    ...
    '(org-level-1 ((t (:inherit nil :foreground "gray"  :height 1.4 :family "futura"))))
    ...
    '(org-list-dt ((t (:foreground "darkblue" :weight bold :background "white" :underline nil ))))
