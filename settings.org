...
(setq org-ref-bibliography-notes "~/Dropbox/Zettelkasten/org/notes.org"
      org-ref-default-bibliography "~/Dropbox/Zettelkasten/org/references.bib"
...
(use-package doi-utils
  :load-path "~/Dropbox/emacs/.emacs.d/org-ref/"
)
...
;(setq org-ref-bibtex-files '("~/Dropbox/Zettelkasten/org/references.bib"))
;(use-package org-id)
