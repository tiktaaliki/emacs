...
'(org-habit-clear-face ((t
  (:foreground "white" :background "DodgerBlue1"))))
    ...
    '(org-ref-cite-face ((t (:foreground "violet red" :underline t :family "Iosevka Term SS09"))))
    ...
    '(org-tag ((t (:foreground "chartreuse3" :slant normal :weight normal :height 130 :family "Iosevka Term SS09"))))
