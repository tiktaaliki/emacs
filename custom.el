(custom-set-faces
 ...
 '(olivetti-fringe ((t (:background "gray0"))))
...
(custom-set-variables
 ...
 '(org-log-note-headings
   '((done . "State %-12s from %-12S %t")
     ...
     (clock-out . "")))
 '(org-modules
   '(ol-bbdb ol-bibtex ol-docview ol-doi ol-eww ol-gnus org-habit org-id ol-info ol-irc ol-mhe org-protocol ol-rmail org-tempo ol-w3m ol-eshell ol-bookmark org-checklist org-notify org-registry))
