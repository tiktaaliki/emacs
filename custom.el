...
(custom-set-faces
 ...
 '(default ((t (:inherit nil :extend nil :stipple nil :background "#282c34" :foreground "#ebdcb2" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 240 :width normal :foundry "PfEd" :family "Fantasque Sans Mono"))))
 ...
 '(org-checkbox-statistics-todo ((t (:inherit org-table :foreground "#ff4447"))))
 '(org-column ((t (:background "gray0" :foreground "pale green" :strike-through nil :underline nil :slant normal :weight normal))))
 '(org-date ((t (:foreground "#d2f1c0" :underline t :family "monofur"))))
 ...
 '(org-level-2 ((t (:inherit outline-1 :extend nil :foreground "#4d79ff" :weight normal :width normal))))
 ...
 '(outline-1 ((t (:extend t :foreground "#77b234" :weight bold :height 1.0 :family "Fantasque sans mono"))))
