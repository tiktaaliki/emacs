...
(custom-set-faces
 ...
 '(org-drawer ((t (:foreground "light sky blue" :height 0.8))))
 '(org-level-1 ((t (:inherit outline-1 :extend nil :foreground "#67baca" :weight normal))))
 '(org-level-2 ((t (:inherit outline-1 :extend nil :foreground "#fbcd4b" :weight normal :width normal))))
 '(org-level-3 ((t (:inherit org-level-2 :extend nil :foreground "#e99787" :weight normal :height 1.0 :family "fantasque sans mono"))))
 '(org-level-4 ((t (:inherit org-level-3 :extend nil :foreground "#8eba43" :height 1.0))))
 '(org-level-5 ((t (:inherit org-level-4 :extend nil :foreground "#5cc5ef"))))
 '(org-level-6 ((t (:inherit org-level-5 :extend nil :foreground "dark goldenrod"))))
 '(org-level-7 ((t (:inherit org-level-6 :extend nil :foreground "#a49592"))))
