...
(custom-set-faces
 ...
 '(org-level-3 ((t (:inherit org-level-2 :extend nil :foreground "indian red"))))
 '(org-level-4 ((t (:inherit org-level-3 :extend nil :foreground "spring green" :height 1.0))))
 '(org-level-5 ((t (:inherit org-level-4 :extend nil :foreground "deep sky blue"))))
