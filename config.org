...
#+RESULTS:
| %e | mode-line-front-space | mode-line-mule-info | mode-line-modified | mode-line-misc-info | mode-line-remote | mode-line-frame-identification | mode-line-buffer-identification |   | mode-line-position | (vc-mode vc-mode) |   | mode-line-modes | mode-line-end-spaces |
