...
#+begin_src emacs-lisp :tangle yes
   ...
   (add-to-list 'load-ptah "~/Dropbox/emacs/")
   (load "pi")
   (load "dired+")
   (load "org-pdfview")
...
#+BEGIN_SRC emacs-lisp :tangle yes
   ...
   (setq org-stuck-projects '("/TODO|PROJ" ("NEXT") ))
   ...
   (setq org-agenda-custom-commands '(
                                      ...
                                      ("e" "all TODOs" tags-todo "-audiovisual+/TODO|PROJ|NEXT"
                                       ((org-agenda-todo-ignore-scheduled t)))
                                      ("v" "all AV tasks" tags-todo "+audiovisual"
                                       ((org-agenda-todo-ignore-scheduled t)))
...
| e | all TODOs             | tags-todo                                                                        | -audiovisual+/TODO | PROJ                                    | NEXT | ((org-agenda-todo-ignore-scheduled t)) |
| v | all AV tasks          | tags-todo                                                                        | +audiovisual       | ((org-agenda-todo-ignore-scheduled t))  |      |                                        |
| h | all HOLD items        | todo                                                                             | HOLD               |                                         |      |                                        |
| g | all UNSCHEDULED todos | ((agenda  ((org-agenda-span 2) (org-agenda-clockreport-mode nil))) (todo TODO    | NEXT))             | ((org-agenda-todo-ignore-scheduled t))  |      |                                        |
*** ORG-AGENDA HYDRA!
#+begin_src emacs-lisp :tangle yes
...
#+RESULTS:
: ((:startgroup) (ndd . 110) (sysadmin . 115) (home . 104) (lis . 108) (csi . 99) (bcc . 98) (:endgroup) (:startgroup) (audiovisual . 118) (read . 114) (research . 101) (ingest . 105) (create . 119) (admin . 97) (cleaning) (cooking) (:endgroup))
   ...
   (setq org-todo-keywords
         (quote
          ((sequence "TODO(t)" "NEXT(n)" "WAIT(w)" "|" "DONE(d)" )
           ...
           (type "AREA(a)" "PROJ(p)"  "HOLD(o)" "BLOCK(b)"  "|" "DONE(d)")
           (sequence "|" "x(c)")
...
#+BEGIN_SRC emacs-lisp :tangle yes
   ...
   (setq org-capture-templates
         '(
           ...
           ("p" "pomodoro" table-line (id "6w81f6q04qi0") "| %u | %^{Pomodoro #} | %^{Minutes} | %^{Task} | %^{Area of focus|ndd|lis|home|sysadmin|} |%^{Mode}| %^{Quality} | %^{Notes}|"  )

           ("r" "reading log" table-line (id "em87rza1mni0") "|%^{Author}|%^{Title}|%u| " )
