...
| b | Habits               | ((tags-todo STYLE="habit"+SCHEDULED<="<today>"))                                                                                                                                                           |                    |                                                                               |                               |           |                                        |                                |      |       |                                    |      |       |                                  |      |       |           |                              |                                        |
| k | all untagged TODOs   | tags-todo                                                                                                                                                                                                  | -{.*}/-HABIT-BLOCK |                                                                               |                               |           |                                        |                                |      |       |                                    |      |       |                                  |      |       |           |                              |                                        |
...
#+BEGIN_SRC emacs-lisp :tangle yes
   ...
   (defvar symbola-font (if (eq system-type 'gnu/linux)
                          ...
                          "Symbola-14"))
   (defvar nanum-font (if (eq system-type 'gnu/linux)
                            (font-spec :name "NanumBarunpen" :size 9)
                          "NanumBarunpen"))
...
(when (fboundp #'set-fontset-font)
  (set-fontset-font t 'korean-ksc5601	
                    ...
                    (font-spec :family "Nanumbarunpen")))
(dolist (item '(("Nanumbarunpen" . 0.71)))
