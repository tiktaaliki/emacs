...
#+BEGIN_SRC emacs-lisp :tangle yes
   ...
   (setq org-agenda-custom-commands '(
                                      ...
                                      ("e" "all TODOs" tags-todo "/TODO|PROJ|NEXT|IN-PROG"
...
| e | all TODOs             | tags-todo                                                                        | /TODO              | PROJ                                    | NEXT | IN-PROG | ((org-agenda-todo-ignore-scheduled t)) |
| h | all HOLD items        | todo                                                                             | HOLD               |                                         |      |         |                                        |
...
#+BEGIN_SRC emacs-lisp :tangle yes
   (setq org-todo-keywords
         (quote
          ((sequence "TODO(t)" "NEXT(n)" "IN-PROG(i)" "WAIT(w)" "|" "DONE(d)" )
           (type "AREA(a)" "PROJ(p)"  "HABIT(h)"   "HOLD(o)" "BLOCK(b)"  "|" "DONE(d)")
           (sequence "|" "x(c)")
...
#+BEGIN_SRC emacs-lisp :tangle yes
   ...
   (setq org-capture-templates
         '(
           ...
           ("p" "pomodoro" table-line (id "6w81f6q04qi0") "| %^{Day & time} | | %^{Task} | %^{Area of focus|ndd|lis|home|sysadmin|} |%^{Mode}|  %^{Notes}|"  )
