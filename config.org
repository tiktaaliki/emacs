...
(setq org-agenda-window-setup 'current-window)
      ...
      #+RESULTS:
      : [nil 24247 26980 691750 300 kiwon/org-agenda-redo-in-other-window nil nil 149000]
...
*** org-agenda custom commands
    #+BEGIN_SRC emacs-lisp :tangle yes
                          ...
                          (setq org-agenda-custom-commands '(
                                  ...
                                  ("e" "all TODOs" todo "TODO")
                                
                                  ("g" "all UNSCHEDULED todos" 
                                   ((agenda "" 
                                            ((org-agenda-span 2)
                                             (org-agenda-clockreport-mode nil)))
                                    (todo "TODO"))
    ...
    | e | all TODOs                             | todo                                                                                                                                              | TODO                                   |                                         |                                        |
    | g | all UNSCHEDULED todos                 | ((agenda  ((org-agenda-span 2) (org-agenda-clockreport-mode nil))) (todo TODO))                                                                   | ((org-agenda-todo-ignore-scheduled t)) |                                         |                                        |
    | d | 2d agenda + undated ADMIN tasks       | ((agenda  ((org-agenda-span 2) (org-agenda-clockreport-mode nil))) (tags-todo admin                                                               | email                                  | browser))                               | ((org-agenda-todo-ignore-scheduled t)) |
    | f | 2d agenda + undated FOCUS tasks       | ((agenda  ((org-agenda-span 2) (org-agenda-clockreport-mode nil))) (tags-todo focus))                                                             | ((org-agenda-todo-ignore-scheduled t)) |                                         |                                        |
...
** org-tags
   ...
   #+RESULTS:
   : ((lis . 108) (:startgroup) (focus . 102) (admin . 97) (home . 104) (block . 98) (habit . 114) (:endgroup) (:startgroup) (CREATE) (:grouptags) (write) (notes) (study) (:endgroup) (:startgroup) (INGEST) (:grouptags) (read) (watch) (listen) (:endgroup) (:startgroup) (email . 101) (browser . 98) (kitchen . 107) (laundry . 100) (cleaning . 99) (:endgroup))
   ...
   (setq org-todo-keywords
         (quote
          ((sequence "TODO(t)" "WAIT(w)" "|" "DONE(d)" )
           (type "AREA(a)" "PROJ(p)"  "HABIT(h)" "BLOCK(b)"  "|" "DONE(d)")
(sequence "|" "x(c)")
...
(setq select-enable-clipboard t
  ...
  ("f" "Anki flashcards"
              entry
              (file+headline "~/Dropbox/Zettelkasten/anki.org" "Dispatch Shelf")
              "* %<%H:%M>   \n:PROPERTIES:\n:ANKI_NOTE_TYPE: Basic (and reversed card)\n:ANKI_DECK: Default\n:END:\n** Front\n%^{Front}\n** Back\n%^{Back}%?")


  ("l" "look up" entry (id "5br4n6815pi0") "* %? \n%U\n  \n%a\n\n\n" :prepend nil)
("m" "meditation" table-line (id "otljx3605ni0") "|%t | %^{Time} | %^{Notes}|" :table-line-pos "II-1" )
