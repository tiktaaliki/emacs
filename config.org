...
(define-key org-mode-map (kbd "M-<f2>") #'my-org-clock-select-task)
...
#+RESULTS:
: [nil 24386 30267 653464 300 kiwon/org-agenda-redo-in-other-window nil nil 130000]
   ...
   (setq org-agenda-custom-commands '(
                                      ...
                                      ("h" "Habits" tags-todo "STYLE=\"habit\"" 
                                       ((org-agenda-overriding-header "Habits")))
                                          ;habits scheduled for todeaf
                                      ("b" "Habits"


( (tags-todo "mentat+STYLE=\"habit\"+SCHEDULED<=\"<today>\"")
(tags-todo "home+STYLE=\"habit\"+SCHEDULED<=\"<today>\"")
(tags-todo "self+STYLE=\"habit\"+SCHEDULED<=\"<today>\"")
(tags-todo "sysadmin+STYLE=\"habit\"+SCHEDULED<=\"<today>\"")
)
                                 )
                                      ...
                                      ("n" "ndd & lis" (
                                                        (tags-todo "lis-/-HABIT-WAIT-HOLD")      (tags-todo "ndd-admin-email-focus-/-HABIT-WAIT-HOLD")
                                      ...
                                      ("u" "all UNSCHEDULED" ((agenda "" 
                                                                      ((org-agenda-span 2)
                                                                       (org-agenda-clockreport-mode nil)))
                                                              (tags-todo "ndd+/TODO|NEXT|TODAY|IN-PROG")
                                                              (tags-todo "lis+/TODO|NEXT|TODAY|IN-PROG")
                                                              (tags-todo "home+/TODO|NEXT|TODAY|IN-PROG")
                                                              (tags-todo "sysadmin+/TODO|NEXT|TODAY|IN-PROG")
                                                              (tags-todo "mentat+/TODO|NEXT|TODAY|IN-PROG"))
...
| b | Habits               | ((tags-todo mentat+STYLE="habit"+SCHEDULED<="<today>") (tags-todo home+STYLE="habit"+SCHEDULED<="<today>") (tags-todo self+STYLE="habit"+SCHEDULED<="<today>") (tags-todo sysadmin+STYLE="habit"+SCHEDULED<="<today>")) |                    |                                                                               |                               |           |                                        |                                |      |       |                                    |      |       |                                  |      |       |           |                              |                                        |
| k | all untagged TODOs   | tags-todo                                                                                                                                                                                                               | -{.*}/-HABIT-BLOCK |                                                                               |                               |           |                                        |                                |      |       |                                    |      |       |                                  |      |       |           |                              |                                        |
| j | home todos           | ((tags-todo cooking-Style="habit") (tags-todo cleaning-Style="habit") (tags-todo self-Style="habit"))                                                                                                                   |                    |                                                                               |                               |           |                                        |                                |      |       |                                    |      |       |                                  |      |       |           |                              |                                        |
| n | ndd & lis            | ((tags-todo lis-/-HABIT-WAIT-HOLD) (tags-todo ndd-admin-email-focus-/-HABIT-WAIT-HOLD) (tags-todo ndd+admin-/-HABIT-WAIT-HOLD) (tags-todo ndd+email-/-HABIT-WAIT-HOLD) (tags-todo ndd+focus-/-HABIT-WAIT-HOLD))              |                    |                                                                               |                               |           |                                        |                                |      |       |                                    |      |       |                                  |      |       |           |                              |                                        |
| d | mentat & sysadmin    | ((tags-todo sysadmin-/-HABIT-WAIT-HOLD) (tags-todo mentat-/-HABIT-WAIT-HOLD))                                                                                                                                             |                    |                                                                               |                               |           |                                        |                                |      |       |                                    |      |       |                                  |      |       |           |                              |                                        |
...
| u | all UNSCHEDULED      | ((agenda  ((org-agenda-span 2) (org-agenda-clockreport-mode nil))) (tags-todo ndd+/TODO                                                                                                                                 | NEXT               | TODAY                                                                         | IN-PROG) (tags-todo lis+/TODO | NEXT      | TODAY                                  | IN-PROG) (tags-todo home+/TODO | NEXT | TODAY | IN-PROG) (tags-todo sysadmin+/TODO | NEXT | TODAY | IN-PROG) (tags-todo mentat+/TODO | NEXT | TODAY | IN-PROG)) | ((org-agenda-max-entries 5)) | ((org-agenda-todo-ignore-scheduled t)) |
...
#+RESULTS:
: ((:startgroup) (ndd . 110) (sysadmin . 115) (home . 104) (lis . 108) (self) (mentat . 109) (:endgroup) (:startgrouptag) (sysadmin . 115) (:grouptags) (emacs . 101) (system) (:endgrouptag) (:startgroup) (admin . 97) (focus . 102) (:endgroup) (:startgroup) (email) (discovery . 100) (intake . 105) (integrate) (:endgroup) (:startgrouptag) (lis . 108) (:grouptags) (bcc) (csi) (job) (:endgrouptag) (:startgrouptag) (mentat . 109) (:grouptags) (korean) (:endgrouptag) (:startgrouptag) (intake) (:grouptags) (listen) (read . 114) (watch . 119) (:endgrouptag) (:startgrouptag) (home . 104) (:grouptags) (cooking) (cleaning) (:endgrouptag))
