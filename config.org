...
| u | all UNSCHEDULED      | ((agenda  ((org-agenda-span 2) (org-agenda-clockreport-mode nil))) (tags-todo ndd+/TODO                                                                                                                                                         | NEXT          | TODAY                                                                         | IN-PROG ((org-agenda-overriding-header NDD)) ((org-agenda-todo-ignore-scheduled t))) (tags-todo lis+/TODO | NEXT      | TODAY                                  | IN-PROG ((org-agenda-overriding-header LIS))) (tags-todo home+/TODO | NEXT | TODAY | IN-PROG ((org-agenda-overriding-header home))) (tags-todo sysadmin+/TODO | NEXT | TODAY | IN-PROG ((org-agenda-overriding-header sysadmin))) (tags-todo mentat+/TODO | NEXT | TODAY | IN-PROG ((org-agenda-overriding-header mentat)))) | ((org-agenda-max-entries 5)) | ((org-agenda-todo-ignore-scheduled t)) |
