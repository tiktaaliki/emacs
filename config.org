...
#+RESULTS:
: [nil 24411 53822 697961 300 kiwon/org-agenda-redo-in-other-window nil nil 296000]
...
#+BEGIN_SRC emacs-lisp :tangle yes
      ...
      (setq org-agenda-custom-commands '(
                                        ...
                                        ("l" "all todos"
                                          ((agenda ""  ((org-agenda-span 1) ))
                                           (alltodo "" 
                                                    ((org-agenda-skip-function '(org-agenda-skip-entry-if 'scheduled 'deadline 'todo '("습관" "HOLD" "WAIT" "PROJ")) )
                                         ...
                                         ("u" "all UNSCHEDULED" ((agenda "" 
                                                                 ...
                                                                 (tags-todo "ndd+/TODO|NEXT|TODAY|IN-PROG"
                                                                            ((org-agenda-overriding-header "NDD"))                                       ((org-agenda-todo-ignore-scheduled t))
                                                                            )

                                                                 (tags-todo "lis+/TODO|NEXT|TODAY|IN-PROG"
                                                                            ((org-agenda-overriding-header "LIS"))
   ((org-agenda-todo-ignore-scheduled t))
                                                                            )
   ...
   ((org-agenda-todo-ignore-scheduled t))
                                                                 ...
                                                                 (tags-todo "sysadmin+/TODO|NEXT|TODAY|IN-PROG"
                                                                            ((org-agenda-overriding-header "sysadmin"))
   ((org-agenda-todo-ignore-scheduled t))
                                                                            )
            (tags-todo "mentat+/TODO|NEXT|TODAY|IN-PROG" ((org-agenda-overriding-header "mentat"))
                       ((org-agenda-todo-ignore-scheduled t))))
...
| l | all todos            | ((agenda  ((org-agenda-span 1))) (alltodo  ((org-agenda-skip-function '(org-agenda-skip-entry-if 'scheduled 'deadline 'todo '(습관 HOLD WAIT PROJ))) (org-agenda-sorting-strategy '(priority-down)))))                                          |               |                                                                               |                                                                                                           |           |                                        |                                                                                                            |      |       |                                                                                                                 |      |       |                                                                                                                   |      |       |                                                                                          |                              |                                        |
| j | home todos           | ((tags-todo cooking-Style="habit") (tags-todo cleaning-Style="habit") (tags-todo self-Style="habit"))                                                                                                                                           |               |                                                                               |                                                                                                           |           |                                        |                                                                                                            |      |       |                                                                                                                 |      |       |                                                                                                                   |      |       |                                                                                          |                              |                                        |
| n | ndd & lis            | ((tags-todo lis-/-HABIT-WAIT-HOLD) (tags-todo editing-/-HABIT-WAIT-HOLD) (tags-todo ndd-admin-email-focus-/-HABIT-WAIT-HOLD) (tags-todo ndd+admin-/-HABIT-WAIT-HOLD) (tags-todo ndd+email-/-HABIT-WAIT-HOLD) (tags-todo ndd+focus-/-HABIT-WAIT-HOLD)) |               |                                                                               |                                                                                                           |           |                                        |                                                                                                            |      |       |                                                                                                                 |      |       |                                                                                                                   |      |       |                                                                                          |                              |                                        |
...
| u | all UNSCHEDULED      | ((agenda  ((org-agenda-span 2) (org-agenda-clockreport-mode nil))) (tags-todo ndd+/TODO                                                                                                                                                         | NEXT          | TODAY                                                                         | IN-PROG ((org-agenda-overriding-header NDD)) ((org-agenda-todo-ignore-scheduled t))) (tags-todo lis+/TODO | NEXT      | TODAY                                  | IN-PROG ((org-agenda-overriding-header LIS)) ((org-agenda-todo-ignore-scheduled t))) (tags-todo home+/TODO | NEXT | TODAY | IN-PROG ((org-agenda-overriding-header home)) ((org-agenda-todo-ignore-scheduled t))) (tags-todo sysadmin+/TODO | NEXT | TODAY | IN-PROG ((org-agenda-overriding-header sysadmin)) ((org-agenda-todo-ignore-scheduled t))) (tags-todo mentat+/TODO | NEXT | TODAY | IN-PROG ((org-agenda-overriding-header mentat)) ((org-agenda-todo-ignore-scheduled t)))) | ((org-agenda-max-entries 5)) | ((org-agenda-todo-ignore-scheduled t)) |
