;;; activity-watch-mode-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "activity-watch-mode" '("activity-watch-")))
