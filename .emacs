...
(custom-set-variables
 ...
 '(org-agenda-files
   (quote
    ("~/Dropbox/Zettelkasten/inbox.org" "~/Dropbox/Zettelkasten/journal.org" "~/Dropbox/Zettelkasten/personal.org" "~/Dropbox/Zettelkasten/notes.org" "~/Dropbox/Zettelkasten/projects.org" "~/Dropbox/Zettelkasten/lis.org" "~/Dropbox/Zettelkasten/ndd.org" "~/Dropbox/Zettelkasten/editing.org")))
 ...
 '(org-ref-pdf-directory "~/Dropbox/Spring 2019/PDFs/")
...
(custom-set-faces
 ...
 '(italic ((t (:foreground "dark magenta" :slant italic))))
 ...
 '(org-scheduled-previously ((t (:foreground "gray21"))))
 '(org-scheduled-today ((t (:foreground "black"))))
 '(org-special-keyword ((t (:weight normal :height 0.85))))
 '(org-tag ((t (:inherit default :foreground "dark violet" :weight normal :height 0.8))))
