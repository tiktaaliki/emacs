...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (toc-org benchmark-init wc-mode magit gruvbox-theme bbdb bibretrieve bibtex-utils pdf-tools interleave company org-ref flyspell-correct-helm helm use-package solarized-theme org-plus-contrib color-theme))))
(custom-set-faces
