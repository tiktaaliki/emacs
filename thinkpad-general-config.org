...
#+RESULTS:
| (lambda nil (visual-line-mode -1) (toggle-truncate-lines 1)) | hl-line-mode |
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (setq org-default-notes-file "~/Dropbox/Zettelkasten/inbox.org")
...
** pdfs
  ...
  #+RESULTS:
  : ((\.pdf\' lambda (file link) (org-pdfview-open link)) (auto-mode . emacs) (directory . emacs) (\.mm\' . default) (\.x?html?\' . default) (\.pdf\' . default))
